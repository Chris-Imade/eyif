...
| `edo_connection` | checkbox group | Yes | Multi-select. Options: Resident, Indigene, Business Based. Submission sends legacy `edoConnection` as the first selected enum value and full `edoConnections` array. |
...
| `edo_connection` | checkbox group | Yes | Multi-select. Submission sends legacy `edoConnection` as the first selected enum value and full `edoConnections` array. |
